...
class create_wdg_overhang:
    ...
    def get_overhang(self, coilspan = None):
        '''
        Returns the winding overhang (connection of the coil sides).

        Parameters
        ----------
        coilspan : integer or list of integers
