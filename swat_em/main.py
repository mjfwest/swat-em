...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        #  initial windings  -----------------------------------
        self.data = datamodel()
        self.data.genwdg(Q = 12, P = 2, m = 3, coil_span = -1, layers = 1)
        ...
        self.data = datamodel()
        self.data.genwdg(Q = 9, P = 8, m = 3, coil_span = 1, layers = 2, turns = 10)
    ...
    def dialog_GenWinding(self):
        ...
        if ret:
            ...
            data = datamodel()
            data.genwdg(Q = ret['Q'], P = ret['P'], m = ret['m'], coil_span = ret['coilspan'], 
    ...
    def dialog_EditWindingLayout(self):
        ...
        if ret:
            ...
            data.set_phases(ret['phases'], coil_span = ret['coilspan'], turns = ret['turns'])
            data.analyse_wdg()
            if ret['overwrite']:
                data.set_title(self.data.get_title()) # use existing title
                data.set_notes(self.data.get_notes()) # use existings notes
