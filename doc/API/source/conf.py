# -*- coding: utf-8 -*-
#
# SWAT-EM documentation build configuration file, created by
...
project = u'SWAT-EM'
copyright = u'2019, Martin Baun'
author = u'Martin Baun'
...
man_pages = [
    (master_doc, 'swat-em', u'SWAT-EM Documentation',
     [author], 1)
]
